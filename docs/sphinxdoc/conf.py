# -*- coding: utf-8 -*-
#
# PyTopo documentation build configuration file, created by
...
project = u'PyTopo'
copyright = u'2016,2019 Akkana Peck'
author = u'Akkana Peck'
...
# Get the major version, just X.Y
versionparts = release.split(".")
if len(versionparts) > 2:
    version = ".".join(versionparts[0:2])
else:
    version = release
...
latex_documents = [
    (master_doc, 'PyTopo.tex', u'PyTopo Documentation',
     u'Akkana Peck', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytopo', u'PyTopo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyTopo', u'PyTopo Documentation',
     author, 'PyTopo', 'One line description of project.',
     'Miscellaneous'),
]
